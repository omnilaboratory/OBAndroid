package com.omni.wallet_mainnet.framelibrary.http.callback;
...
import com.omni.wallet_mainnet.framelibrary.entity.UpdateEntity;
import com.omni.wallet_mainnet.framelibrary.entity.User;
import com.omni.wallet_mainnet.framelibrary.entity.event.HttpStateEvent;
import com.omni.wallet_mainnet.framelibrary.http.gson.GSonUtils;
import com.omni.wallet_mainnet.framelibrary.utils.ErrorCodeTips;
import com.omni.wallet_mainnet.framelibrary.utils.LoginUtils;
import com.omni.wallet_mainnet.framelibrary.utils.LogoutUtils;
import com.omni.wallet_mainnet.framelibrary.utils.PreferencesUtils;
import com.omni.wallet_mainnet.framelibrary.utils.UpdateUtils;
        ...
        try {
            ...
            if (responseEntity != null) {
                ...
                if (HttpConfig.CODE_REQUEST_SUCCESS.equals(code)) {// 接口返回成功
                    ...
                    try {
                        ...
                        postMainThread(new Runnable() {
                            ...
                            public void run() {
                                // 回调回去
                                onResponseFail(context, com.omni.wallet_mainnet.baselibrary.common.Constants.CODE_ERROR_FORMAT, "");
                            }
                        });
                    }
                ...
                postMainThread(new Runnable() {
                    @Override
                    public void run() {
                        onResponseError(context, com.omni.wallet_mainnet.baselibrary.common.Constants.CODE_ERROR_REQUEST, "请求超时");
                    }
                });
            }
        } catch (Exception e) {
