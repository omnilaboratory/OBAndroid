...
import com.omni.testnet.baselibrary.http.dialog.LoadingDialog;
...
import com.omni.testnet.baselibrary.utils.MD5Utils;
...
import com.omni.testnet.framelibrary.entity.UpdateEntity;
import com.omni.testnet.framelibrary.entity.User;
import com.omni.testnet.framelibrary.entity.event.HttpStateEvent;
import com.omni.testnet.framelibrary.http.gson.GSonUtils;
import com.omni.testnet.framelibrary.utils.ErrorCodeTips;
import com.omni.testnet.framelibrary.utils.LoginUtils;
import com.omni.testnet.framelibrary.utils.LogoutUtils;
import com.omni.testnet.framelibrary.utils.PreferencesUtils;
import com.omni.testnet.framelibrary.utils.UpdateUtils;
        ...
        try {
            ...
            if (responseEntity != null) {
                ...
                if (HttpConfig.CODE_REQUEST_SUCCESS.equals(code)) {// 接口返回成功
                    ...
                    try {
                        ...
                        postMainThread(new Runnable() {
                            ...
                            public void run() {
                                // 回调回去
                                onResponseFail(context, com.omni.testnet.baselibrary.common.Constants.CODE_ERROR_FORMAT, "");
                            }
                        });
                    }
                ...
                postMainThread(new Runnable() {
                    @Override
                    public void run() {
                        onResponseError(context, com.omni.testnet.baselibrary.common.Constants.CODE_ERROR_REQUEST, "请求超时");
                    }
                });
            }
        } catch (Exception e) {
