package com.omni.testnet.thirdsupport.zxing;
...
import com.omni.testnet.thirdsupport.R;
import com.omni.testnet.thirdsupport.zxing.camera.CameraManager;
...
public class CaptureHandler extends Handler implements ResultPointCallback {
    ...
    public void handleMessage(Message message) {
        ...
        } else if (message.what == R.id.light_change) {// 光线变化
            boolean isDark = (boolean) message.obj;
            onCaptureListener.onLightChange(isDark);
        }
    }
