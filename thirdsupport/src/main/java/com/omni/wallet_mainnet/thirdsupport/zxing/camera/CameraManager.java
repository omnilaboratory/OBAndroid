package com.omni.wallet_mainnet.thirdsupport.zxing.camera;
...
import com.omni.wallet_mainnet.thirdsupport.zxing.camera.open.OpenCamera;
import com.omni.wallet_mainnet.thirdsupport.zxing.camera.open.OpenCameraInterface;
...
public final class CameraManager {
    ...
    // 当前闪关灯的模式
    private int mFlashMode = CameraConfig.FLASH_MODE_AUTO;
    ...
    public void resetFlashMode() {
        this.mFlashMode = CameraConfig.FLASH_MODE_AUTO;
        changeFlashMode();
    }
    ...
    private void changeFlashMode() {
        ...
        Camera.Parameters parameters = cameraObject.getParameters();
        if (mFlashMode == CameraConfig.FLASH_MODE_TORCH) {
            parameters.setFlashMode(Camera.Parameters.FLASH_MODE_TORCH);
        } else if (mFlashMode == CameraConfig.FLASH_MODE_OFF) {
