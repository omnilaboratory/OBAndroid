...
/**
 * 汉: 创建通道提示的弹窗
 * En: CreateChannelTipDialog
 * author: guoyalei
 * date: 2023/2/3
 */
public class CreateChannelTipDialog {
    private static final String TAG = CreateChannelTipDialog.class.getSimpleName();

    private Context mContext;
    private AlertDialog mAlertDialog;

    public CreateChannelTipDialog(Context context) {
    ...
    public void show() {
        ...
        tipTv.setText(mContext.getString(R.string.create_channel_tip));
        /**
         * @描述： 点击back
