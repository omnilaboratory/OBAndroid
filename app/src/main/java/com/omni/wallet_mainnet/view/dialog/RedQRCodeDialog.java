 ...
 * date: 2023/3/16
 */
public class RedQRCodeDialog {
    private static final String TAG = RedQRCodeDialog.class.getSimpleName();
    private Context mContext;
    private AlertDialog mAlertDialog;

    public RedQRCodeDialog(Context context) {
    ...
    public void show(String qrCodeCotent) {
        ...
        Bitmap mQRBitmap = RedCodeUtils.createQRCode(qrCodeCotent, DisplayUtil.dp2px(mContext, 250));
