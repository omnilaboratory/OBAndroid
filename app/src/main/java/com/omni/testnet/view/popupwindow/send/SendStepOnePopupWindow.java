...
import com.omni.testnet.ui.activity.ScanSendActivity;
import com.omni.testnet.utils.Wallet;
import com.omni.testnet.view.dialog.LoadingDialog;
import com.omni.testnet.view.dialog.SendSuccessDialog;
import com.omni.testnet.view.popupwindow.SelectAssetPopupWindow;
import com.omni.testnet.view.popupwindow.SelectSpeedPopupWindow;
...
//                        mBasePopWindow.dismiss();
    ...
    private void showStepTwo(View view) {
        ...
        sendFeeExchangeTv = view.findViewById(R.id.tv_send_fee_exchange);
        if (assetId == 0) {
