...
public class UnlockActivityBack extends AppBaseActivity {
    Context ctx = UnlockActivityBack.this;
    String localPass ="";
    String localSeed = "";
...
//            
            ...
            Toast checkPassToast = Toast.makeText(UnlockActivityBack.this,toastString,Toast.LENGTH_LONG);
