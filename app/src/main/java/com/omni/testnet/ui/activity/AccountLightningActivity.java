...
import com.omni.testnet.baselibrary.view.refreshView.RefreshLayout;
import com.omni.testnet.data.AccountAssetsData;
import com.omni.testnet.entity.AssetTrendEntity;
...
import com.omni.testnet.entity.event.LockEvent;
...
import com.omni.testnet.entity.event.UpdateBalanceEvent;
import com.omni.testnet.framelibrary.entity.User;
import com.omni.testnet.framelibrary.view.refreshlayout.LayoutRefreshView;
...
import com.omni.testnet.view.AssetTrendChartView;
...
import com.omni.testnet.view.dialog.ReceiveLuckyPacketDialog;
import com.omni.testnet.view.dialog.SendDialog;
import com.omni.testnet.view.popupwindow.AccountManagePopupWindow;
...
import com.omni.testnet.view.popupwindow.MenuPopupWindow;
import com.omni.testnet.view.popupwindow.SelectNodePopupWindow;
...
//        mRefreshLayout.autoRefresh();
    ...
    /**
     * Get testnet related information
     * 获取钱包相关信息
     */
...
//                    });
    ...
    /**
     * Set the created new testnet address as the default testnet address
     * 将创建新的钱包地址设置为默认钱包地址
     */
    ...
    /**
     * 汉：点击copy图标复制地址
     * En：Click copy icon button,duplicate user`s testnet address to clipboard
...
//                mCreateChannelStepOnePopupWindow.show(mParentLayout, balanceAmount, User.getInstance().getWalletAddress(mContext), event.getData());
    ...
    /**
     * 选择钱包地址后的消息通知监听
     * Message notification monitoring after selecting testnet address
     */
    @Subscribe(threadMode = ThreadMode.MAIN)
