...
public class RegWalletInfo extends BasePreferencesUtils {
    ...
    public static void saveNodeVersion(Context context,String value){
        putString(REG_WALLET_INFO,context,NODE_VERSION,value);
    }

    public static String getNodeVersion(Context context){
        return getString(REG_WALLET_INFO, context, NODE_VERSION);
    }

    public static void saveStartParams(Context context, String value) {
        putString(REG_WALLET_INFO, context, START_PARAMS, value);
    }

    public static String getStartParams(Context context) {
        return getString(REG_WALLET_INFO, context, START_PARAMS);
    }
}
